...
class OrderTile extends StatelessWidget {
  ...
  String _buildProductsText(DocumentSnapshot snapshot) {
    ...
    for (LinkedHashMap p in snapshot.data()['products']) {
      text +=
          '${p['quantity']} x ${p['product']['title']} (US\$ ${p['product']['price'].toStringAsFixed(2)})\n';
    }
    text += 'Total: US\$ ${snapshot.data()['totalPrice'].toStringAsFixed(2)}';
    return text;
  }
